...
function screenUpdate() {
	...
	content_3Title.style.fontSize = "30px";	
	   ...
	   content_3Body_Container.style.left = "73%";
	   content_3Body_Container.style.width = "28%";
	   content_3Body_Container.style.height = "50%";
	   content_3Img.style.backgroundSize = "580px 355px";
	   content_3Img.style.backgroundPosition = "-150px 0px";
